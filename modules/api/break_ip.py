    ...
    def main(self, _answer="all", view="ini", _mode="w"):
        match self.mode:
            case "HTML":
                ...
                Type(self.debug).__html__(my_name, Handler["continent"], Handler["country"], Handler["regionName"], Handler["city"], Handler["lat"], Handler["lon"], Handler["isp"], Handler["org"], Handler["as"], Handler["asname"], Handler["reverse"], Handler["mobile"], Handler["proxy"], Handler["hosting"], path=self.way)
            case "OnlyText":
                Handler = self.__sendrequest__()
                match self.autoprint:
                    case True:
                        print(Type(self.debug).__text__(my_name, Handler["continent"], Handler["country"], Handler["regionName"], Handler["city"], Handler["lat"], Handler["lon"], Handler["isp"], Handler["org"], Handler["as"], Handler["asname"], Handler["reverse"], Handler["mobile"], Handler["proxy"], Handler["hosting"], _answer=_answer))
                    case False:
                        Type(self.debug).__text__(my_name, Handler["continent"], Handler["country"], Handler["regionName"], Handler["city"], Handler["lat"], Handler["lon"], Handler["isp"], Handler["org"], Handler["as"], Handler["asname"], Handler["reverse"], Handler["mobile"], Handler["proxy"], Handler["hosting"], _answer=_answer)
            case "JSON":
                Handler = self.__sendrequest__()
                Type(self.debug).__json__(my_name, Handler["continent"], Handler["country"], Handler["regionName"], Handler["city"], Handler["lat"], Handler["lon"], Handler["isp"], Handler["org"], Handler["as"], Handler["asname"], Handler["reverse"], Handler["mobile"], Handler["proxy"], Handler["hosting"], path=self.way)
            case "FileAnswer":
                Handler = self.__sendrequest__()
                Type(self.debug).__file__(my_name, Handler["continent"], Handler["country"], Handler["regionName"], Handler["city"], Handler["lat"], Handler["lon"], Handler["isp"], Handler["org"], Handler["as"], Handler["asname"], Handler["reverse"], Handler["mobile"], Handler["proxy"], Handler["hosting"], path=self.way, view=view, _mode=_mode)
            case _:
